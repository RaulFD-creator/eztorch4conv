...
def test_eztorch4conv_imported():
    input_parameters = ez.utils.parse_inputs("../data/input_params.json")
    ...
    dcnn_model.features = nn.Sequential(
        ...
        ez.layers.fire3d(in_channels=12, squeeze_channels=32, expand1x1_channels=24, expandnxn_channels=24, 
